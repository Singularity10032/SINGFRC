...
const seasons: Season[] = [
  {
    ...
    members: [
      ...
      { name: "Chaitu Polavarapu", year: "Senior" },
      { name: "Chetan Kapavarapu", year: "Senior" },
      { name: "Dheemanth Suddekunte", year: "Junior" },
      { name: "Dhruva", year: "Senior" },
      { name: "Eshwar", year: "Senior" },
      ...
      { name: "Sathyndhira", year: "Freshman" },
  ...
  },
  {
    ...
    members: [
      { name: "Meghana Chodavarapu", year: "Senior" },
      { name: "Sofy Gutierrez", year: "Senior" },
      { name: "Jose Hernandez", year: "Senior" },
      { name: "Mayank Jain", year: "Senior" },
      { name: "Shreyas Kadari", year: "Senior" },
      { name: "Rayhan Mohammad", year: "Senior" },
      { name: "Kaushal Prasath", year: "Senior" },
      { name: "Diya Sangal", year: "Senior" },
      { name: "Tanush Saxena", year: "Senior" },
      { name: "Ethan Zheng", year: "Senior" },
      { name: "Rishi Alluri", year: "Junior" },
      { name: "Nirbhay Challa", year: "Junior" },
      ...
      { name: "Chaitu Polavarapu", year: "Junior" },
      { name: "Amrith Ponneth", year: "Junior" },
      { name: "Sachin Rajan", year: "Junior" },
      { name: "Sanjana Rajaram", year: "Junior" },
      { name: "Raghav Ramprasad", year: "Junior" },
      { name: "Kavin Ravi", year: "Junior" },
      { name: "Aadhitya Senthilkumar", year: "Junior" },
