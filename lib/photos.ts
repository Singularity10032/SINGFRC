...
export const photos = {
  ...
  // Home "Engineering" card (dad's pick #7, 2026-09-16): ORION mid-match.
  // Taken out of the ORION gallery set so it does not repeat.
  engineering: { src: "/images/photos/image-2.webp", width: 1280, height: 960 },
