...
export const photos = {
  ...
  // Home "Engineering" card (dad's pick, 2026-09-16): ORION's bare chassis on the
  // mats during build season. Taken out of the ORION gallery set so it does not repeat.
  engineering: { src: "/images/photos/IMG-1385.webp", width: 1650, height: 2200 },
